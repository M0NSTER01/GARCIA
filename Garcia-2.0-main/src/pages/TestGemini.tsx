...
const testGeminiText = async (): Promise<string> => {
  const API_KEY = 'AIzaSyC7u7pZbavGr4RtelgdLxbrppGxUTpzpcg';
  
  try {
    // Basic text request to gemini-pro
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              ...
              <div className="mt-4 border-t border-yellow-200 pt-3">
                ...
                <p className="mt-1">
                  As of July 2024, this application now uses the Gemini 1.5 Flash model since Gemini Pro Vision was deprecated. 
